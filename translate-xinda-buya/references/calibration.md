...
- https://zh.wikipedia.org/zh-hans/%E4%BF%A1%E8%BE%BE%E9%9B%85
...
Default to Level 2 roughness. Use Level 1 only when safety, explicit user restraint, or sensitive public context requires a lighter version. Use Level 3 when the user asks for more dirty, angry, roast-like, or internet-flame output.

| Source effect | Prefer | Avoid |
| --- | --- | --- |
| Formal request | "赶紧把...给办了", "别拖", "少整虚的" | "敬请", "烦请", "如蒙" |
| Plain statement | "说白了", "这玩意儿就是", "别装" | ornate transitions like "诚然", "由此观之" |
| Neutral process | "先干这个，再搞那个", "别把活干岔了" | "请依次执行以下步骤" |
...
- For subtitles/dialogue, make it speakable: short clauses, clear subject, no explanatory padding.
...
Translation: `他把锅全甩我身上了。`

Source: `Screw this. I'm out.`
Translation: `去他的，我不干了。`

Source: `Please review the attached document by Friday.`
Translation: `周五前把附件给看了，别他妈拖。`

Source: `We need to align on the plan before launch.`
Translation: `上线前先把方案对齐了，别到时候又整一地鸡毛。`

Source: `This approach may introduce unnecessary complexity.`
Translation: `这搞法可能纯属给自己加戏，把事儿整复杂了。`

Source: `What the hell are you doing?`
Translation options:
- Level 1: `你到底在搞什么？`
- Level 2: `你他妈在搞什么？`
- Level 3: `你他妈到底在发什么疯？`
